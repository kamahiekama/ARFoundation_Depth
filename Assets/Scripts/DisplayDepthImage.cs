...
namespace UnityEngine.XR.ARFoundation.Samples
{
    ...
    public class DisplayDepthImage : MonoBehaviour
    {
        ...
        [SerializeField]
        RawImage[] m_RawImages = new RawImage[3];
        ...
        void Update()
        {
            for (int i = 0; i < 3; i++)
            {
                DisplayMode displayMode = (DisplayMode)i;
                ...
                Debug.Assert(m_RawImages[i] != null, "no raw image");
                m_RawImages[i].texture = displayTexture;
        ...
        void OnCameraFrameEventReceived(ARCameraFrameEventArgs cameraFrameEventArgs)
        {
            for (int i = 0; i < 3; i++)
            {
                ...
                Debug.Assert(m_RawImages[i] != null, "no raw image");
                if (m_RawImages[i].material != null)
                {
                    ...
                    m_RawImages[i].material.SetMatrix(k_DisplayRotationPerFrameId, m_DisplayRotationMatrix);
                }
            }
        }
